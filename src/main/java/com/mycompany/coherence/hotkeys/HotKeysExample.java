...
public class HotKeysExample {
	...
	HotKeysExample hotKeys = new HotKeysExample(cacheName, cacheServiceName, invocationServiceName, topN);
	hotKeys.fetch();
    }
     ...
     * 
     * @param cacheName
     * @param distributedCacheServicename
     * @param invocationServiceName
     * @param topN
     */
    public HotKeysExample(String cacheName, String distributedCacheServicename, String invocationServiceName, int topN) {
	super();
	...
	InvocationObserver observer = new HotKeyInvocationObserver<Integer>(countDownLatch, startTime,
		invocationResults);
	...
	new HelpFormatter().printHelp(HotKeysExample.class.getSimpleName(), cliOptions);
    }
