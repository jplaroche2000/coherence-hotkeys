...
/**
 * InvocationObserver for observing the progress of asynchronous Invocable execution.
 */
public class HotKeyInvocationObserver<K extends Comparable<K>>
    ...
    public HotKeyInvocationObserver(CountDownLatch countDownLatch,
            long startTime,
    ...
    public void memberCompleted(Member member, Object result) {
        invocationResults.put(member,
                (SortedCollectionWithCapacity<HotKeyData<K>>) result);
    ...
    public void memberLeft(Member member) {
        ...
        CacheFactory.log(String
                .format("Member left before task completed: %s", member));
    }
